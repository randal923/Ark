...
})(["width:15px;height:2px;background:white;transition:all 0.2s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-5px);}::after{transform:translateY(5px);}", ""], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["background:transparent;::before{transform:rotate(45deg) translate(5px,-5px);}::after{transform:rotate(-45deg) translate(5px,5px);}"]);
  }
});
...
//# sourceMappingURL=index.js.63d04a3574a5d1e2e6e4.hot-update.js.map