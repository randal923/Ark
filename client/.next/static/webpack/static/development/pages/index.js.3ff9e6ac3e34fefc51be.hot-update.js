...
})(["display:flex;align-items:center;justify-content:center;width:25px;height:25px;cursor:pointer;transition:all 0.5s ease-in-out;"]);
var Burger = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  ...
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateX(-10px);background:transparent;::before{transform:rotate(45deg) translate(5px,-5px);}::after{transform:rotate(-45deg) translate(5px,5px);}"]);
  }
});
...
//# sourceMappingURL=index.js.3ff9e6ac3e34fefc51be.hot-update.js.map