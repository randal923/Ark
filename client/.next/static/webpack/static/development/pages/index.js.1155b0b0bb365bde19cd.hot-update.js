...
})(["div{:first-child{width:15px;height:1px;background:white;transition:transform 0.1806s cubic-bezier(0.04,0.04,0.12,0.96),-webkit-transform 0.1806s cubic-bezier(0.04,0.04,0.12,0.96);margin-bottom:4px;", "}:last-child{width:15px;height:1px;background:white;transition:transform 0.1806s cubic-bezier(0.04,0.04,0.12,0.96),-webkit-transform 0.1806s cubic-bezier(0.04,0.04,0.12,0.96);", "}}"], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateY(2px);transform:rotate(45deg);"]);
  }
}, function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateY(-2px);transform:rotate(-45deg);"]);
...
//# sourceMappingURL=index.js.1155b0b0bb365bde19cd.hot-update.js.map