...
})(["::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-2px);}::after{transform:translateY(2px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.723611d5a347d22eae69.hot-update.js.map