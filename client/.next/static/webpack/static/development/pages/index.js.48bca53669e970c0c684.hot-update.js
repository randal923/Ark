...
})(["position:relative;width:25px;height:25px;span{:first-child{position:absolute;top:50%;left:50%;transform:translate(50%,-50%) width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}:last-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}}"], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.48bca53669e970c0c684.hot-update.js.map