...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.5rem;color:var(--light-text-color);width:100%;background:linear-gradient(#393939,#424242);text-decoration:none;border-bottom:1px;padding:0.7rem;:hover,:focus{color:white;background:var(--blue);}}}"]);


/***/ })

})
//# sourceMappingURL=index.js.d08098a5e0fd3e81ee78.hot-update.js.map