...
})(["display:flex;align-items:center;justify-content:center;width:20px;height:20px;cursor:pointer;transition:all 0.5s ease-in-out;background:red;margin-left:5px;position:relative;border:1px solid white;"]);
...
})(["position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-3.5px);}::after{transform:translateY(3.5px);}", ""], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["::before{transform:translateY(-3.5px);}::after{transform:translateY(3.5px);}"]);
  }
});
...
//# sourceMappingURL=index.js.dd0edb4262c479f11fe7.hot-update.js.map