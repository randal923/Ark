...
})(["background:linear-gradient(#393939,#424242);min-width:100%;border-radius:1rem;border-style:groove;border-width:1px;border-color:#171717;height:3.5rem;font-family:Arial;padding:0 1rem 0 1rem;display:grid;align-items:center;grid-template-columns:1fr 15fr 1fr;align-items:center;justify-items:center;img{display:none;}> ssvg{color:var(--blue);}@media (max-width:37.5em){grid-template-columns:1fr 1fr;align-self:center;border-radius:0;border-width:0;svg{justify-self:start;}}"]);
...
})(["display:none;:hover,:focus{cursor:pointer;color:white;background:var(--blue);}span{background:#383737;color:white;padding:2px;border:1px solid #323232;}@media (max-width:37.5em){display:block;display:flex;flex-direction:column;width:20rem;background:linear-gradient(#393939,#424242);a{font-size:1.5rem;color:var(--light-text-color);width:100%;text-decoration:none;border:0;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:var(--blue);}}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.8f24a44f8ac5890f91a2.hot-update.js.map