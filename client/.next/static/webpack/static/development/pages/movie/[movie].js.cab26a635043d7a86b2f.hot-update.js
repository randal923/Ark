...
/* harmony import */ var _global_MediaQueries__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../global/MediaQueries */ "./global/MediaQueries.js");


var Container = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "styles__Container",
  componentId: "sc-1wi7dc9-0"
})(["background:linear-gradient(#393939,#424242);min-width:100%;border-radius:1rem;border-style:groove;border-width:1px;border-color:#171717;height:3.5rem;font-family:Arial;padding:0 1rem 0 1rem;display:grid;align-items:center;grid-template-columns:1fr 15fr 1fr;align-items:center;justify-items:center;img{display:none;}svg{color:var(--blue);:hover{cursor:pointer;color:white;}}@media (max-width:37.5em){grid-template-columns:1fr 1fr;align-self:center;border-radius:0;border-width:0;svg{justify-self:start;}}"]);
...
var media = function media(breakpoint) {
  switch (breakpoint) {
    case 'phone':
      return Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["css"])(["@media (max-width:37.5em){}"]);
  }
};
...
//# sourceMappingURL=[movie].js.cab26a635043d7a86b2f.hot-update.js.map