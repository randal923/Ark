...
})(["position:absolute;display:flex;flex-direction:column;width:35rem;z-index:4;height:100%;border-bottom:1px solid var(--blue);background:white;a{text-decoration:none;color:var(--ligh-text-color);font-size:1.4rem;:hover,:focsu{cursor:pointer;color:var(--blue);}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.d3b31ea9e072e5b34ed5.hot-update.js.map