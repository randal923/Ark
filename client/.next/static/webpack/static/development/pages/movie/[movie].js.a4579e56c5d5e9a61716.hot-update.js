...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(SubMenu, [{
    ...
    value: function renderMobileMainMenu() {
      return __jsx(_styles__WEBPACK_IMPORTED_MODULE_10__["MobileMainMenu"], {
        __source: {
        ...
        __self: this
      }, "Store")), __jsx(next_link__WEBPACK_IMPORTED_MODULE_6___default.a, {
        href: "/",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 24
        ...
        __self: this
      }, "Library")), __jsx(next_link__WEBPACK_IMPORTED_MODULE_6___default.a, {
        href: "/",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 27
        ...
        __self: this
      }, "Community")), __jsx(next_link__WEBPACK_IMPORTED_MODULE_6___default.a, {
        href: "/",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 30
    ...
    value: function renderSubMenu() {
      return __jsx(_styles__WEBPACK_IMPORTED_MODULE_10__["Container"], {
        ...
        size: 25,
        onClick: this.renderMobileMainMenu,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 59
        },
    ...
    value: function render() {
      return __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, this.renderSubMenu(), this.renderMobileSubMenu(), this.renderMobileMainMenu());
    }
  }]);
...
/*!**************************************!*\
  !*** ./components/SubMenu/styles.js ***!
  \**************************************/
/*! exports provided: Container, Search, Menu, DropDown, DropDownContent, MobileSubMenu, MobileMainMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MobileMainMenu", function() { return MobileMainMenu; });
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! styled-components */ "./node_modules/styled-components/dist/styled-components.browser.esm.js");

var Container = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "styles__Container",
  componentId: "sc-1wi7dc9-0"
})(["background:linear-gradient(#393939,#424242);min-width:100%;border-radius:1rem;border-style:groove;border-width:1px;border-color:#171717;height:3.5rem;font-family:Arial;padding:0 1rem 0 1rem;display:grid;align-items:center;grid-template-columns:1fr 15fr 1fr;align-items:center;justify-items:center;img{display:none;}> svg:first-child{background:#383737;color:white;padding:2px;border:1px solid #323232;}svg{color:var(--blue);}@media (max-width:37.5em){grid-template-columns:1fr 1fr;align-self:center;border-radius:0;border-width:0;svg{justify-self:start;}}"]);
...
var MobileMainMenu = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "styles__MobileMainMenu",
  componentId: "sc-1wi7dc9-6"
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.5rem;color:var(--light-text-color);width:100%;background:#393939;text-decoration:none;border:0;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:var(--blue);}}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.a4579e56c5d5e9a61716.hot-update.js.map