...
})(["position:absolute;display:flex;flex-direction:column;width:20rem;min-height:100%;z-index:4;border-right:1px solid var(--blue);background:linear-gradient(#1f1f1f,#242424);transition:background 0.25s,color 0.25s;a{text-decoration:none;color:var(--ligh-text-color);font-size:1.7rem;padding:0.5rem 1rem;width:100%;border-top:1px solid #2f3138;border-bottom:1px solid rgba(0,0,0,0.1);:hover,:focus{cursor:pointer;color:var(--blue);}a:last-child{border-bottom:1px solid #2f3138;}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.a6cb392168604412fd22.hot-update.js.map