...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;width:20rem;background:linear-gradient(#393939,#424242);a{font-size:1.5rem;color:var(--light-text-color);width:100%;text-decoration:none;border:0;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:var(--blue);}}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.7b727ef8581a640a2c59.hot-update.js.map