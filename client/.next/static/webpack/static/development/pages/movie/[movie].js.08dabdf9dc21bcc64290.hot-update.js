...
})(["position:absolute;display:flex;flex-direction:column;width:20rem;height:100vh;z-index:4;border-right:1px solid var(--blue);background:linear-gradient(#1f1f1f,#242424);a{text-decoration:none;color:var(--ligh-text-color);font-size:1.4rem;:hover,:focus{cursor:pointer;color:var(--blue);}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.08dabdf9dc21bcc64290.hot-update.js.map