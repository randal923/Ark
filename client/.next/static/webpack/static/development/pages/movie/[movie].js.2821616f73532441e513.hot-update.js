...
})(["position:absolute;display:flex;flex-direction:column;width:20rem;min-height:100%;z-index:4;border-right:1px solid var(--blue);background:linear-gradient(#1f1f1f,#242424);a{text-decoration:none;color:var(--ligh-text-color);font-size:1.7rem;padding:0.5rem 1rem;width:100%;border-bottom:1px solid #000000;:hover,:focus{cursor:pointer;color:var(--blue);}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.2821616f73532441e513.hot-update.js.map