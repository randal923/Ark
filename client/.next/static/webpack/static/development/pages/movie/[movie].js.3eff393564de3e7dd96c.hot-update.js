...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.6rem;color:rgba(255,255,255,0.7);width:100%;background:var(--blue);text-decoration:none;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:black;}}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.3eff393564de3e7dd96c.hot-update.js.map