...
/*!**************************************!*\
  !*** ./components/SubMenu/styles.js ***!
  \**************************************/
/*! exports provided: Container, Search, Menu, DropDown, DropDownContent, MobileSubMenu, MobileMainMenu, BackDrop, Content */
...
var Content = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  ...
  componentId: "sc-1wi7dc9-8"
})([":hover,:focus{cursor:pointer;color:white;background:var(--blue);}span{background:#383737;color:white;padding:2px;border:1px solid #323232;}display:flex;flex-direction:column;width:20rem;height:100%;background:linear-gradient(#393939,#424242);a{font-size:1.5rem;color:var(--light-text-color);width:100%;text-decoration:none;border:0;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:var(--blue);}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.d92513a2fcb762755d2b.hot-update.js.map