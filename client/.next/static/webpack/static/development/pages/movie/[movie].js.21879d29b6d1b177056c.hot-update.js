...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.6rem;color:rgba(255,255,255,0.7);width:100%;background:var(--blue);text-decoration:none;a{border-width:51px;border-color:#171717;}:not(:last-child){margin-right:1.5rem;}:hover{color:white;}}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.21879d29b6d1b177056c.hot-update.js.map