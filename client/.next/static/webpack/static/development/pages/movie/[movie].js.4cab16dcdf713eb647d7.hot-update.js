...
})(["display:none;@media (max-width:", "){display:flex;align-items:center;justify-content:space-between;background:linear-gradient(#393939,#424242);img{height:30px;width:30px;}svg{margin-right:10px;margin-left:10px;}}"], _global_breakpoints__WEBPACK_IMPORTED_MODULE_1__["breakPoints"].mobile);


/***/ })

})
//# sourceMappingURL=[movie].js.4cab16dcdf713eb647d7.hot-update.js.map