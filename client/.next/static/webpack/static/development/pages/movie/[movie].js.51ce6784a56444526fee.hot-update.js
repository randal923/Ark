...
})(["display:grid;grid-template-columns:1fr;grid-template-rows:2.6rem 10rem 3.5rem;background:linear-gradient(#181f2d,#212225);@media (max-width:", "){grid-template-columns:1fr;grid-template-rows:3.5rem 1fr;background:rgba(0,0,0,0.92);}"], _global_breakpoints__WEBPACK_IMPORTED_MODULE_1__["breakPoints"].mobile);
...
})(["display:flex;align-items:center;h1{font-size:5rem;}> img{height:8rem;width:8rem;}@media (max-width:", "){display:none;}"], _global_breakpoints__WEBPACK_IMPORTED_MODULE_1__["breakPoints"].mobile);
...
})(["display:none;@media (max-width:", "){display:flex;align-items:center;justify-content:space-between;img{height:3rem;width:3rem;}}"], _global_breakpoints__WEBPACK_IMPORTED_MODULE_1__["breakPoints"].mobile);


/***/ })

})
//# sourceMappingURL=[movie].js.51ce6784a56444526fee.hot-update.js.map