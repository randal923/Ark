...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.6rem;color:rgba(255,255,255,0.7);width:100%;background:var(--blue);text-decoration:none;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:#0080c6;}}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.a22f36d59d6c102edcc5.hot-update.js.map