...
})(["display:none;@media (max-width:", "){display:flex;align-items:center;justify-content:space-between;background:rgba(0,0,0,0.92);img{height:30px;width:30px;}svg{margin-right:10px;margin-left:10px;:nth-child(2){color:blue;}}}"], _global_breakpoints__WEBPACK_IMPORTED_MODULE_1__["breakPoints"].mobile);


/***/ })

})
//# sourceMappingURL=[movie].js.b7f6ffbf8873f847ea7e.hot-update.js.map