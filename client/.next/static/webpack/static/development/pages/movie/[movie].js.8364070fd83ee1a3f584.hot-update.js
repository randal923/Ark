...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.6rem;color:rgba(255,255,255,0.7);width:100%;background:var(--blue);text-decoration:none;border-width:1px;a{border-color:#171717;}:not(:last-child){margin-right:1.5rem;}:hover{color:white;}}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.8364070fd83ee1a3f584.hot-update.js.map