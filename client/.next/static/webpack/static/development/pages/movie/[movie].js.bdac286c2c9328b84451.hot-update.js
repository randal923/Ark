...
})(["position:absolute;top:0;bottom:0;width:100%;min-height:100%;z-index:3;overflow:hidden;background-color:rgba(0,0,0,0.4);"]);
var Content = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "styles__Content",
  componentId: "cgmaqc-2"
})(["position:absolute;display:flex;flex-direction:column;width:20rem;min-height:100%;z-index:4;border-right:1px solid var(--blue);background:linear-gradient(#1f1f1f,#242424);overflow:hidden;a{text-decoration:none;color:var(--ligh-text-color);font-size:1.4rem;:hover,:focus{cursor:pointer;color:var(--blue);}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.bdac286c2c9328b84451.hot-update.js.map