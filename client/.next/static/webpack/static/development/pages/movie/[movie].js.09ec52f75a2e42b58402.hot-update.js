...
})(["position:absolute;display:flex;flex-direction:column;width:35rem;z-index:4 \xE7 height:100%;border-bottom:1px solid var(--blue);background:white;a{text-decoration:none;color:var(--ligh-text-color);font-size:1.4rem;:hover{cursor:pointer;color:var(--blue);}}"]);


/***/ })

})
//# sourceMappingURL=[movie].js.09ec52f75a2e42b58402.hot-update.js.map