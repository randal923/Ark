...
})(["width:15px;height:0px;background:transparent;transition:all 0.3s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.3s ease-in-out;}::before{transform:translateY(-3px);}::after{transform:translateY(3px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.11d35863a54fe9866515.hot-update.js.map