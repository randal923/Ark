...
})(["position:absolute;opacity:0.8;z-index:3;top:0;width:48px;height:48px;cursor:pointer;-webkit-transition:opacity 0.3s cubic-bezier(0.25,0.1,0.25,1);transition:opacity 0.3s cubic-bezier(0.25,0.1,0.25,1);-webkit-tap-highlight-color:transparent;span{display:block;:first-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}:last-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}}"], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.4826a8affd20bd68e5fd.hot-update.js.map