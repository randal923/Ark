...
})(["width:15px;height:0px;background:transparent;transition:all 0.3s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;}::before{transform:translateY(-4px);}::after{transform:translateY(4px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.54231e2459dfbf78929a.hot-update.js.map