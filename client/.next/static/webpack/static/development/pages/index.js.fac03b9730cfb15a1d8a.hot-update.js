...
})(["::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-3px);}::after{transform:translateY(3px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.fac03b9730cfb15a1d8a.hot-update.js.map