...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.5rem;font-weight:400;color:var(--light-text-color);width:100%;background:#0080c6;text-decoration:none;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:var(--blue);}}}"]);


/***/ })

})
//# sourceMappingURL=index.js.1c2f7340047894616897.hot-update.js.map