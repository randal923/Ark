...
})(["position:absolute;top:0px;bottom:0px;width:100%;z-index:1;background-color:rgba(0,0,0,0.4);"]);
var Content = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "styles__Content",
  componentId: "sc-1omickw-2"
})(["background-color:#242424;border:1px solid rgba(0,166,255,0.4);border-radius:5px;width:60rem;height:40rem;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr;position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);background:green;z-index:2;"]);
...
//# sourceMappingURL=index.js.c14e1bedf6835a5b0e4f.hot-update.js.map