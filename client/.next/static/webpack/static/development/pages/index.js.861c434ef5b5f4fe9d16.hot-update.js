...
var Container = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].span.withConfig({
  ...
  if (props.type === 'danger') {
    ...
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["css"])(["button{color:white;background:linear-gradient(#50a1e1,#3c78a6);border:1px solid var(--blue);:hover{color:var(--light-text-color);background:var(--blue);}}"]);
...
//# sourceMappingURL=index.js.861c434ef5b5f4fe9d16.hot-update.js.map