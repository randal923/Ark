...
})(["width:15px;height:0px;background:transparent;transition:all 0.3s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.3s ease-in-out;}::before{transform:translateY(-4px);}::after{transform:translateY(4px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.cfbfdfe7e6fda6de3858.hot-update.js.map