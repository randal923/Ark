...
})(["width:15px;height:2px;background:transparent;transition:all 0.3s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.3s ease-in-out;}::before{transform:translateY(-5px);}::after{transform:translateY(5px);}", ""], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["background:transparent;::before{transform:rotate(45deg);}::after{transform:rotate(-45deg);}"]);
  }
});
...
//# sourceMappingURL=index.js.87933cb19ab0eadb55ba.hot-update.js.map