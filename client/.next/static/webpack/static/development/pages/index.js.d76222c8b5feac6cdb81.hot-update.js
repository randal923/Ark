...
})(["display:flex;align-items:center;justify-content:center;width:20px;height:20px;cursor:pointer;transition:all 0.5s ease-in-out;background:red;margin-left:5px;position:relative;"]);
...
})(["::before,::after{content:'';position:absolute;top:50%;left:50%;margin-right:auto;margin-left:auto;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-3.5px);}::after{transform:translateY(3.5px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.d76222c8b5feac6cdb81.hot-update.js.map