...
})(["background:linear-gradient(#1f1f1f,#2424124);border:1px solid rgba(0,166,255,0.4);border-radius:5px;width:60rem;height:40rem;position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);z-index:2;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr;justify-items:center;align-items:center;"]);
...
})(["width:90%;height:23rem;padding:1rem;border-right:1px solid #454545;margin-bottom:8rem;h3:first-child{margin-bottom:1.5rem;}img{height:5rem;width:5rem;}input{margin:0.5rem 0 1rem 0;width:80%;}button{margin-left:14.8rem;}"]);
...
//# sourceMappingURL=index.js.993723d87bcc649cca1a.hot-update.js.map