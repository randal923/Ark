...
})(["::before,::after{content:'';position:absolute;top:50%;right:50%;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-3.5px);}::after{transform:translateY(3.5px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.44a8f6a4275a2a12d28d.hot-update.js.map