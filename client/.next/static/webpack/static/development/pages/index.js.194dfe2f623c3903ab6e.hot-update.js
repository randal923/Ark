...
})(["position:relative;display:flex;justify-content:center;align-items:center;width:25px;height:25px;cursor:pointer;margin-left:10px;"]);
...
})(["width:15px;height:2px;background:white;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:background 0s transform 0.5s ease-in-out;}::before{transform:translateY(-5px);}::after{transform:translateY(5px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.194dfe2f623c3903ab6e.hot-update.js.map