...
})(["width:15px;height:2px;background:white;transition:all 0s;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-5px);}::after{transform:translateY(5px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.127e7900d9e9989a53b5.hot-update.js.map