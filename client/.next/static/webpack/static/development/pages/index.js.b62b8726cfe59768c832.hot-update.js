...
})(["width:100%;display:flex;flex-direction:column;justify-content:center;padding:1rem;img{height:5rem;width:5rem;}input{margin:0.5rem 0 1rem 0;}"]);
...
})(["width:100%;padding:1rem;display:flex;flex-direction:column;justify-content:center;button{padding:1.2rem 2.5rem;font-weight:600;margin:2rem;font-size:1.8rem;}p{margin-bottom:3rem;color:var(--medium-text-color);}"]);


/***/ })

})
//# sourceMappingURL=index.js.b62b8726cfe59768c832.hot-update.js.map