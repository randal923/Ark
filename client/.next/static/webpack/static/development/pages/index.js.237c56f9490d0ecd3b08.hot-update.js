...
})([":hover,:focus{cursor:pointer;color:white;background:var(--blue);}span{background:#383737;color:white;padding:2px;border:1px solid #323232;}display:flex;flex-direction:column;width:20rem;background:linear-gradient(#393939,#424242);a{font-size:1.5rem;color:var(--light-text-color);width:100%;text-decoration:none;border:0;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:var(--blue);}}"]);


/***/ })

})
//# sourceMappingURL=index.js.237c56f9490d0ecd3b08.hot-update.js.map