...
})(["position:absolute;display:flex;flex-direction:column;width:20rem;min-height:100%;z-index:4;border-right:1px solid var(--blue);background:linear-gradient(#1f1f1f,#242424);a{text-decoration:none;color:var(--ligh-text-color);font-size:1.7rem;margin:2rem;:hover,:focus{cursor:pointer;color:var(--blue);}}"]);


/***/ })

})
//# sourceMappingURL=index.js.7cf21ec1e6aac6fde3c2.hot-update.js.map