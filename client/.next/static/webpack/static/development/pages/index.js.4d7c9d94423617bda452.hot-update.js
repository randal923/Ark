...
})(["position:relative;display:flex;justify-content:center;align-items:center;width:25px;height:25px;cursor:pointer;transition:all 0.5s ease-in-out;margin-left:10px;"]);
...
})(["width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-5px);}::after{transform:translateY(5px);}", ""], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateX(-5px);background:transparent;::before{transform:rotate(45deg) translate(10px,-10px);}::after{transform:rotate(-45deg) translate(10px,10px);}"]);
  }
});
...
//# sourceMappingURL=index.js.4d7c9d94423617bda452.hot-update.js.map