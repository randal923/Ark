...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.5rem;color:var(--light-text-color);width:100%;background:#393939;text-decoration:none;border-bottom:1px;padding:0.7rem;border-bottom:1px solid #171717;:hover,:focus{color:white;background:var(--blue);}}}"]);


/***/ })

})
//# sourceMappingURL=index.js.de46e75ae484dd2218b5.hot-update.js.map