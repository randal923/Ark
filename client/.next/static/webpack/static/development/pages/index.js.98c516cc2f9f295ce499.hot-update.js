...
})(["display:block;position:absolute;opacity:.8;top:0;width:25px;height:25px;cursor:pointer;-webkit-transition:opacity 0.3s cubic-bezier(0.25,0.1,0.25,1);transition:opacity 0.3s cubic-bezier(0.25,0.1,0.25,1);-webkit-tap-highlight-color:transparent;span{:first-child{position:absolute;z-index:3;top:9px;left:9px;width:30px;height:30px;-webkit-transition:opacity 0.3s cubic-bezier(0.25,0.1,0.25,1);transition:opacity 0.3s cubic-bezier(0.25,0.1,0.25);", "}:last-child{position:absolute;z-index:3;top:50%;left:50%;width:30px;height:30px;-webkit-transition:opacity 0.3s cubic-bezier(0.25,0.1,0.25,1);transition:opacity 0.3s cubic-bezier(0.25,0.1,0.25);", "}}"], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.98c516cc2f9f295ce499.hot-update.js.map