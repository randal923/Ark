...
})(["span{display:inline-block;:first-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;margin-bottom:4px;", "}:last-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}}"], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.7dde51b6699d60d32051.hot-update.js.map