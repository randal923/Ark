...
})(["width:15px;height:1px;background:transparent;transition:all 0.3s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;}::before{transform:translateY(-3px);}::after{transform:translateY(3px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.bb2a7d5e14289ff71f8d.hot-update.js.map