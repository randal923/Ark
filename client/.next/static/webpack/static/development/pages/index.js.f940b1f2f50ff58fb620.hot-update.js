...
})(["background-color:#242424;border:1px solid rgba(0,166,255,0.4);border-radius:5px;width:60rem;height:40rem;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr;position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);z-index:2;align-items:center;justify-items:center;"]);
...
})(["width:100%;padding:1rem;h3{margin:1.5rem 0 3rem 0;}img{height:5rem;width:5rem;}input{margin:0.5rem 0 1rem 0;}"]);
...
})(["width:100%;padding:1rem;h3{margin:1.5rem 0 3rem 0;}button{padding:1.2rem 2.5rem;font-weight:600;margin:2rem;font-size:1.8rem;}p{margin-bottom:3rem;}"]);


/***/ })

})
//# sourceMappingURL=index.js.f940b1f2f50ff58fb620.hot-update.js.map