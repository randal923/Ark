...
})(["position:relative;width:25px;height:25px;span{:first-child{position:absolute;width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}:last-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}}"], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.ee8bf761dc0a70c96010.hot-update.js.map