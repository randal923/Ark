...
})(["display:flex;align-items:center;justify-content:center;width:25px;height:25px;cursor:pointer;transition:all 0.5s ease-in-out;background:transparent;margin-left:5px;background:red;"]);
var Burger = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].span.withConfig({
  displayName: "styles__Burger",
  componentId: "w2b10l-4"
})(["display:inline-block;span{display:inline-block;:first-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}:last-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}}"], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateY(2px) rotate(45deg);"]);
  }
}, function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateY(-2px) rotate(-45deg);"]);
...
//# sourceMappingURL=index.js.0f63f2535f872cc00f07.hot-update.js.map