...
})(["div{:first-child{position:absolute;width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;margin-bottom:4px;", "}:last-child{position:absolute;width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}}"], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.eb8ec627097e730f3e14.hot-update.js.map