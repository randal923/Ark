...
})(["width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;transform:translateX(-30px);::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-5px);}::after{transform:translateY(5px);}", ""], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateX(-30px);"]);
  }
});
...
//# sourceMappingURL=index.js.95a11fa5ff37cf07780c.hot-update.js.map