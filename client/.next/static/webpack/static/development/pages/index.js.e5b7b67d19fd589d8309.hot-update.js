...
})(["div{:first-child{width:15px;height:1px;background:white;transition:all 0.5s ease-in-out;margin-bottom:4px;", "}:last-child{width:15px;height:1px;background:white;transition:all 0.5s ease-in-out;", "}}"], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateY(4px);"]);
  }
}, function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translateY(-10px);"]);
  }
});
...
//# sourceMappingURL=index.js.e5b7b67d19fd589d8309.hot-update.js.map