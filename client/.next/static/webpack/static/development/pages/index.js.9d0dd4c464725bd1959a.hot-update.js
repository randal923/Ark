...
})(["width:100%;height:23rem;padding:1rem;display:grid;grid-template-columns:1fr;grid-template-rows:1fr 1fr 1fr;justify-items:center;margin-bottom:2rem;h3:first-child{margin-bottom:1.5rem;justify-self:start;}button{padding:1.2rem 2.5rem;font-weight:600;margin:2rem;font-size:1.8rem;}p{margin-bottom:1rem;color:var(--medium-text-color);}"]);


/***/ })

})
//# sourceMappingURL=index.js.9d0dd4c464725bd1959a.hot-update.js.map