...
})(["display:none;@media (max-width:37.5em){display:block;display:flex;flex-direction:column;a{font-size:1.6rem;color:var(--light-text-color);width:100%;background:#0080c6;text-decoration:none;:not(:last-child){margin-right:1.5rem;}:hover,:focus{color:white;background:var(--blue);}}}"]);


/***/ })

})
//# sourceMappingURL=index.js.5b545d264baed36fe72a.hot-update.js.map