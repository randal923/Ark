...
})(["background-color:#242424;border:1px solid rgba(0,166,255,0.4);border-radius:5px;width:60rem;height:40rem;position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);z-index:2;display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr;"]);
...
})(["width:100%;height:100%;display:flex;flex-direction:column;justify-content:center;padding:1rem;img{height:5rem;width:5rem;}input{margin:0.5rem 0 1rem 0;}"]);
...
})(["width:100%;height:100%;padding:1rem;display:flex;flex-direction:column;justify-content:center;button{padding:1.2rem 2.5rem;font-weight:600;margin:2rem;font-size:1.8rem;}p{margin-bottom:3rem;color:var(--medium-text-color);}"]);


/***/ })

})
//# sourceMappingURL=index.js.ae1e3ff2c317217371bf.hot-update.js.map