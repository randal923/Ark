...
})(["display:none;@media (max-width:", "){display:flex;align-items:center;justify-content:space-between;background:rgba(0,0,0,0.92);", " img{height:30px;width:30px;}svg{margin-right:10px;margin-left:10px;:nth-child(3){text-shadow:0px 0px 1px red;color:white;}}}"], _global_breakpoints__WEBPACK_IMPORTED_MODULE_1__["breakPoints"].mobile, function (props) {
...
//# sourceMappingURL=index.js.0e584c9f99d5688b5564.hot-update.js.map