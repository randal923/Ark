...
})(["::before,::after{content:'';position:absolute;top:50%;left:100%;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-3.5px);}::after{transform:translateY(3.5px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.fb4bfc64bef3eadf773f.hot-update.js.map