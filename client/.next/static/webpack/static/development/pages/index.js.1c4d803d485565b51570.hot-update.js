...
})(["span{:first-child{display:inline-block;width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}:last-child{display:inline-block;width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}}"], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.1c4d803d485565b51570.hot-update.js.map