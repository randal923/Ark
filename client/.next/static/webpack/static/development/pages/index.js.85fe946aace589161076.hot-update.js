...
})(["grid-column:2 / span 3;justify-self:end;a{color:var(--blue);text-decoration:none;:hover{color:var(--light-text-color);}}> span{display:flex;align-items:center;background:#353535;padding-left:1rem;border-radius:0.4rem;}> div{display:flex;align-items:center;:hover{color:var(--blue);cursor:pointer;}svg{color:var(--blue);}}"]);
...
//# sourceMappingURL=index.js.85fe946aace589161076.hot-update.js.map