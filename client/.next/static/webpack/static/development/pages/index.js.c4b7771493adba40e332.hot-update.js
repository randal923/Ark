...
})(["display:none;@media (max-width:", "){display:block;display:flex;flex-direction:column;a{font-size:1.5rem;color:var(--light-text-color);width:100%;background:#393939;text-decoration:none;padding:0.7rem;border-bottom:1px solid rgba(69,69,69,0.4);:hover,:focus{color:white;background:var(--blue);}}}"], _global_breakpoints__WEBPACK_IMPORTED_MODULE_1__["breakPoints"].tablet);


/***/ })

})
//# sourceMappingURL=index.js.c4b7771493adba40e332.hot-update.js.map