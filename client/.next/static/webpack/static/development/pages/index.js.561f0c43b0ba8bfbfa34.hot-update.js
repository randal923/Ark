...
})(["position:relative;display:flex;justify-content:center;align-items:center;width:25px;height:25px;cursor:pointer;transition:all 0.5s ease-in-out;border:1px solid white;margin-left:10px;"]);
...
})(["width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::before{transform:translateY(-5px);}::after{transform:translateY(5px);}"]);


/***/ })

})
//# sourceMappingURL=index.js.561f0c43b0ba8bfbfa34.hot-update.js.map