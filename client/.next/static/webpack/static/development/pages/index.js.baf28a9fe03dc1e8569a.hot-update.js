...
})(["width:100%;height:100%;padding:1rem;img{height:5rem;width:5rem;}input{margin:0.5rem 0 1rem 0;}"]);
...
})(["width:100%;height:100%;padding:1rem;display:flex;justify-content:center;flex-direction:column;button{padding:1.2rem 2.5rem;font-weight:600;margin:2rem;font-size:1.8rem;}p{margin-bottom:3rem;color:var(--medium-text-color);}"]);


/***/ })

})
//# sourceMappingURL=index.js.baf28a9fe03dc1e8569a.hot-update.js.map