...
})(["width:90%;height:23rem;padding:1rem;border-right:1px solid #454545;margin-bottom:10rem;h3:first-child{margin-bottom:1.5rem;}img{height:5rem;width:5rem;}input{margin:0.5rem 0 1rem 0;width:80%;}button{}"]);
...
})(["width:100%;height:23rem;padding:1rem;display:grid;grid-template-columns:1fr;grid-template-rows:1fr 1fr 1fr;justify-items:center;margin-bottom:10rem;h3:first-child{margin-bottom:1.5rem;justify-self:start;}button{padding:1.2rem 2.5rem;font-weight:600;margin:2rem;font-size:1.8rem;}p{margin-bottom:1rem;color:var(--medium-text-color);}"]);


/***/ })

})
//# sourceMappingURL=index.js.0a9b38d49f7b3af7a554.hot-update.js.map