...
})(["display:flex;align-items:center;justify-content:center;width:25px;height:25px;cursor:pointer;transition:all 0.5s ease-in-out;background:transparent;margin-left:5px;"]);
...
})(["div{:first-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;margin-bottom:4px;", "}:last-child{width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;", "}}"], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translate(2px,4px) rotate(45deg);"]);
  }
}, function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["transform:translate(-2px,-2px) rotate(-45deg);"]);
  }
});
...
//# sourceMappingURL=index.js.c7637a8e470b90a80d92.hot-update.js.map