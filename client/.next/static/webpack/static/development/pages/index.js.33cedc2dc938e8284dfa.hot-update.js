...
})(["position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.5s ease-in-out;}::after{transform:translateY(3.5px);}", ""], function (props) {
  if (props.show) {
    return Object(styled_components__WEBPACK_IMPORTED_MODULE_1__["css"])(["::after{transform:translateY(3.5px);}"]);
  }
});
...
//# sourceMappingURL=index.js.33cedc2dc938e8284dfa.hot-update.js.map