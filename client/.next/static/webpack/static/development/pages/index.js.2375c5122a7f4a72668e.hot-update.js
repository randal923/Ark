...
})(["width:15px;height:2px;background:white;transition:all 0.2s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:2px;background:white;transition:all 0.2s ease-in-out;}::before{transform:translateY(-5px);}::after{transform:translateY(5px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.2375c5122a7f4a72668e.hot-update.js.map