...
})(["width:15px;height:0px;background:transparent;transition:all 0.3s ease-in-out;::before,::after{content:'';position:absolute;width:15px;height:1px;background:white;transition:all 0.3s ease-in-out;}::before{transform:translateY(-3px);}::after{transform:translateY(3px);}", ""], function (props) {
  if (props.show) {
...
//# sourceMappingURL=index.js.44e80155b7981ce8c493.hot-update.js.map